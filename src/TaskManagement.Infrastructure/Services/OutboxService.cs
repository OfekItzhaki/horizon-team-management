...
namespace TaskManagement.Infrastructure.Services
{
    public class OutboxService : IOutboxService
    {
        ...
        public async System.Threading.Tasks.Task EnqueueMessageAsync<T>(T message, CancellationToken cancellationToken = default)
        {
            ...
            await System.Threading.Tasks.Task.CompletedTask; // Saving is handled by the caller's SaveChangesAsync or we can add it here if preferred.
